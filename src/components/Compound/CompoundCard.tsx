...
CompoundCard.Image = function Image() {
    return (
        <img
...
CompoundCard.Rating = function Rating({ total }) {
    return (
...
CompoundCard.PriceBox = function PriceBox({ children }) {
    return <div className="flex items-center justify-between">{children}</div>
}

CompoundCard.Price = function Price({ price }) {
    return (
...
CompoundCard.Cart = function Cart() {
    return (
        <a
            href="#"
...
CompoundCard.Select = function Select({ options }) {
    return (
